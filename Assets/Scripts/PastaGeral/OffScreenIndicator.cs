...
class OffscreenMarkersCameraScript : MonoBehaviour
{
    ...
    private List<OffScreenIndicator> _trackedObjects = new List<OffScreenIndicator>();

    public void Register(OffScreenIndicator om)
    {
    ...
    void OnGUI()
    {
        ...
        {
            OffScreenIndicator marker = _trackedObjects[i];
